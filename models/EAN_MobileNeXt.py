...
def mobilenext(num_classes=1000, width_mult=1., pretrained=True):
    model = MobileNeXt(num_classes=num_classes, width_mult=width_mult)
...
if __name__ == '__main__':
    ...
    model = mobilenext(num_classes=1000, width_mult=1., pretrained=False)
